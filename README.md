...
Traducción a JavaScript (si el texto es válido) El archivo output.js contendrá el código generado.

4-Para ver el árbol sintáctico, abrí el archivo SimpleAnalizador.g4, seleccionar la extensión de ANTLR y presionar F5.
